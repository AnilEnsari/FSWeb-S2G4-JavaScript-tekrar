...
function CemberinCevresi(yaricap /* kodlar buraya */) {
  return 2 * pi * yaricap;
  /* kodlar buraya */
}
...
/* 	GÖREV 2:  
		- CemberinAlani fonksiyonunu kullanarak aşağıdaki yönergeleri uygulayın:
			...
			3. Çemberin alanı hesaplanacaktır (💡 İPUCU: Çemberin alanı = pi * yarıçapın karesini bulmak için Javascript içinde tanımlı Math kütüphanesini kullanabilirsiniz. Math.pow(yaricap,2))
			4. Hesaplanan çemberin alanı döndürülecektir.n karesi, yarıçapı
		*/

function CemberinAlani(yaricap2, pi /* kodlar buraya */) {
...
/* 	GÖREV 3:
		- Sayfanın en üstünde global değişken olarak tanımlanmış bir sayilar dizisi bulunmaktadır. Bu dizi içinde 0 ile 1000 arasında rasgele odeğişkenlereluşturulmuş tam sayılar ve ondalıklı sayılar bulunmaktadır. Bu diziyi kullanarak aşağıdakileri uygulayın:
			3a. enbuyuk ve enkucuk isminde 2 adet değişken tanımlayın ve sayilar dizisindeki en küçük sayı ile en büyük sayıyı bu  atayın. (for döngüsü kullanın)
...
function enKucukf(array3a) {
  let enKucuk = 10000000;
  for (let i = 0; i < sayilar.length; i++) {
...
console.log(enbuyuk);
console.log(enBuyukf(sayilar));
console.log(enKucukf(sayilar));
console.log(enkucuk);
...
//3d çözümü
besyuzdenkucuksayilar = sayilar.filter((x) => {
  return x < 500;
});

/* kodlar buraya */

//3e çözümü function compareNumbers(a, b) {
//return a - b;
// NumberArray.sort(compareNumbers)
function sayilariKarsilastir(a, b) {
  return a - b;
}
siralisayilar = besyuzdenkucuksayilar.sort(sayilariKarsilastir);
